...
void loop() {
  ...
  const int serialPrintInterval = 0; //increase to slow serial print activity
...
void calibrate() {
  ...
  float newCalibrationValue = LoadCell.getNewCalibration(known_mass); //get new calibration value
